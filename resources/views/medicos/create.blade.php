        ...
        <div class="card-body">
          <form method="POST" action="{{route('medicos.store')}}">
            ...
            <div class="form-group">
              ...
              <input type="date" name="f_nacimiento" id="f_nacimiento" class="form-control" placeholder="Ingrese el Apellido" aria-describedby="helpId">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" name="direccion" id="direccion" class="form-control" placeholder="Ingrese su Dirección" aria-describedby="helpId">
            </div>
            <div class="form-group">
              <label for="">Rol</label>
